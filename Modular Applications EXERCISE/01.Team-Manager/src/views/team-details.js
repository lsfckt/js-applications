...
const teamDetailsTemp = (info) => html`
            <section id="team-home">
                <article class="layout">
                    <img src=${info.logoUrl} class="team-logo left-col">
...
export async function teamDetails(e) {

    const id = e.target.id;

    const info = await get(`/data/teams/${id}`);
    return info;
}

export function details(ctx) {
    ctx.render(teamDetailsTemp(teamDetails()));
}